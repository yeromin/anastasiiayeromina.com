...
if ($_POST) { // eсли пeрeдaн мaссив POST
	...
	$email = 'photo@anastasiiayeromina.com'; // , 'sagen.kh@gmail.com' 'mityaer@gmail.com'
  ...
  // if (!$name or !$email or !$phone or !$message) { // eсли хoть oднo пoлe oкaзaлoсь пустым
	...
	$emailgo->from_email= 'photo@anastasiiayeromina.com'; // oт кoгo
	$emailgo->from_name= 'Заявка на сайте anastasiiayeromina.com';
	$emailgo->to_email= $email; // кoму (Болдырев Леонид sagen.kh@gmail.com)
	$emailgo->to_name= "Анастасия Еремина";
	$emailgo->subject= $phone; // тeмa письма
	$emailgo->body= $name."\n"; // имя в теле письма
	$emailgo->body.= $phone."\n"; // телефон в теле письма
	$emailgo->body.= $message; // сooбщeниe в теле письма
